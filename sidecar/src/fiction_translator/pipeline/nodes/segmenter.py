...
from fiction_translator.pipeline.constants import DIALOGUE_MARKERS, SPEAKER_PATTERNS
from fiction_translator.pipeline.state import SegmentData, TranslationState
